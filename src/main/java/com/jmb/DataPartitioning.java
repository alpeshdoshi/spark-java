...
public class DataPartitioning {
    ...
    private void init() throws Exception {
        ...
        //Define a Spark based Partition function as a lambda - used to inspect the contents of the partitions..
        //this function operates on each of the partition rows..
        ...
        //sort(columns..)  causes shuffling
        //Shuffling is an action of re-arranging data between partitions and the nodes where those partitions live
