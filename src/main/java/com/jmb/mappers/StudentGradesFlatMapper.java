...
import java.util.*;
import static com.jmb.BasicTranformationsFlatMapAndDistinct.getStudentsFlattenedSchema;

public class StudentGradesFlatMapper implements FlatMapFunction<Row, Row> {

    @Override
    public Iterator<Row> call(Row row) throws Exception {
        //GenericRowWithSchema maps each row to provided schema getStudentsFlattenedSchema
