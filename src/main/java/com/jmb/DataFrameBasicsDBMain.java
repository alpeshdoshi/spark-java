...
public class DataFrameBasicsDBMain {
    ...
    private void init() throws Exception {
        ...
        //this operation is applied to each row within the DataFrame by each worker node.
        ...
        //this will generate multiple csv files in spark-data directory because of spark's distributed processing nature
        // several csv files are co-related to each worker node that process this output-to-file operation
