...
public class BasicTranformationsFlatMapAndDistinct {

    private static final Logger LOGGER = LoggerFactory.getLogger(BasicTranformationsFlatMapAndDistinct.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        BasicTranformationsFlatMapAndDistinct app = new BasicTranformationsFlatMapAndDistinct();
        app.init();
